...
import { Leaf, Flame, Fish, Wheat, Coffee, GlassWater, Star, Wine } from 'lucide-react';
...
export default function Menu() {
  ...
  const categories = [
    ...
    { id: 'bebidas', name: 'Bebidas', icon: Fish },
  ];
    ...
    <div>
      ...
      <section className="py-20 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {MOCK_MENU[activeCategory as keyof typeof MOCK_MENU].map((item, index) => (
              <div
                key={index}
      ...
      <section className="py-16 bg-white border-t border-neutral-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-serif text-neutral-900 mb-4">Pronto para experimentar?</h2>
          <p className="text-neutral-600 mb-8">
            Garanta sua mesa e desfrute de uma experiência culinária inesquecível.
          </p>
